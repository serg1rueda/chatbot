...
DB_PASSWORD = os.getenv("DB_PASSWORD", "nacionalrey17")  # Cambia por tu password
...
cur.close()
conn.close()
print("✅ Base de datos PostgreSQL creada con todos los temas y preguntas")
